 ...
 * Date: April 21, 2024.
 * Purpose: Controller class which implements complete functionality into our Company Budgeting App GUI
 */
...
public class AccountingAppController {
    ...
    @FXML
    private TextField transactionConfirmationDisplay;
    ...
    public void depositFunds() {
        ...
        switch (selected_dept) {
                case "Sales":
                    ...
                    // Set text for Transaction Confirmation Text Field
                    transactionConfirmationDisplay.setText(" + " + currency.format(amount) + " to Sales");
                ...
                case "Marketing":
                    ...
                    transactionConfirmationDisplay.setText(" + " + currency.format(amount) + " to Marketing");
                ...
                case "Production":
                    ...
                    transactionConfirmationDisplay.setText(" + " + currency.format(amount) + " to Production");
                ...
                case "IT":
                    ...
                    transactionConfirmationDisplay.setText(" + " + currency.format(amount) + " to IT");
                ...
                case "HR":
                    ...
                    transactionConfirmationDisplay.setText(" + " + currency.format(amount) + " to HR");
    ...
    public void withdrawFunds() {
        ...
        switch (selected_dept) {
            case "Sales":
                ...
                transactionConfirmationDisplay.setText(" - " + currency.format(amount) + " from Sales");
                salesDeptBudgetDisplay.setText(currency.format(new_sales_budget));
                break;
            case "Marketing":
                BigDecimal current_marketing_budget = new BigDecimal(marketingDeptBudgetDisplay.getText().replace(",", "").replace("$", ""));
                BigDecimal new_marketing_budget = current_marketing_budget.subtract(amount);
                transactionConfirmationDisplay.setText(" - " + currency.format(amount) + " from Marketing");
                marketingDeptBudgetDisplay.setText(currency.format(new_marketing_budget));
                break;
            case "Production":
                BigDecimal current_production_budget = new BigDecimal(productionDeptBudgetDisplay.getText().replace(",", "").replace("$", ""));
                BigDecimal new_production_budget = current_production_budget.subtract(amount);
                transactionConfirmationDisplay.setText(" - " + currency.format(amount) + " from Production");
                productionDeptBudgetDisplay.setText(currency.format(new_production_budget));
                break;
            case "IT":
                BigDecimal current_it_budget = new BigDecimal(ITDeptBudgetDisplay.getText().replace(",", "").replace("$", ""));
                BigDecimal new_it_budget = current_it_budget.subtract(amount);
                transactionConfirmationDisplay.setText(" - " + currency.format(amount) + " from IT");
                ITDeptBudgetDisplay.setText(currency.format(new_it_budget));
                break;
            case "HR":
                BigDecimal current_hr_budget = new BigDecimal(HRDeptBudgetDisplay.getText().replace(",", "").replace("$", ""));
                BigDecimal new_hr_budget = current_hr_budget.subtract(amount);
                transactionConfirmationDisplay.setText(" - " + currency.format(amount) + " from HR");
                HRDeptBudgetDisplay.setText(currency.format(new_hr_budget));
                break;
        }
